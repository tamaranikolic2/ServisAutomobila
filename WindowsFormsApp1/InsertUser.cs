...
namespace WindowsFormsApp1
{
    public partial class InsertUser : Form
    {
        ...
        {
            if (String.IsNullOrEmpty(tb_username.Text) || String.IsNullOrWhiteSpace(tb_name.Text) || String.IsNullOrEmpty(tb_surname.Text) ||  String.IsNullOrEmpty(tb_phone.Text) || String.IsNullOrEmpty(tb_car.Text))
            {
